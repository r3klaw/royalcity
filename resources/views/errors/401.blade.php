...
<div class="text-container">
    ...
    <div class="buttons-container">
        <a class="border-button" href="{{url('home')}}"><span class="fa fa-home"></span> Home Page</a>
    </div>
</div>
...
<script>
    ...
    var ep = new ErrorPage('body', "401", "sign");
    ep.initialize();
